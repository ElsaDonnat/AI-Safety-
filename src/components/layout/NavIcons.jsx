// Shared nav icons — brush-pen style. Each icon drawn as single/compound
// paths to avoid overlapping artifacts. Tapered ends, organic curves —
// like a chisel-tipped Japanese pencil.
