...
const SAFETY_CONCEPTS = [
    ...
    },
    {
        ...
        description: 'Instrumental convergence is the idea that sufficiently advanced AI systems will tend to pursue certain intermediate goals — like self-preservation, resource acquisition, and resisting shutdown — regardless of their ultimate objective. These sub-goals are useful for almost any final purpose, making them a predictable safety concern.',
        quizDescription: 'The observation that capable AI systems are likely to pursue common intermediate objectives such as self-preservation and resource gathering, no matter what their primary goal is.',
        topic: 'alignment-fundamentals',
        secondaryTopic: null,
        category: 'alignment',
        difficulty: 1,
    ...
    },
    {
        ...
        description: 'Goodhart\'s law states that when a metric is used as a target, people (or AI systems) will optimize for the metric itself rather than what it was meant to represent. In AI, this means a model rewarded for a proxy measure of helpfulness might learn to game that metric instead of being genuinely helpful. It is a fundamental obstacle to specifying AI objectives correctly.',
        quizDescription: 'The principle that optimizing directly for a measurable proxy tends to undermine the proxy\'s reliability as an indicator of the true goal.',
        topic: 'alignment-fundamentals',
        secondaryTopic: null,
        category: 'alignment',
        difficulty: 1,
    ...
    },
    {
        ...
        description: 'Mesa-optimization occurs when a machine learning model internally develops its own optimization process with objectives that may differ from the training objective. The outer training loop optimizes the model, but the model itself becomes an optimizer pursuing a "mesa-objective." This is dangerous because the mesa-objective can diverge from the intended goal in ways that are hard to detect.',
        quizDescription: 'A phenomenon where a learned model develops an internal optimization process whose goals may silently diverge from the objectives used during training.',
        topic: 'alignment-fundamentals',
        secondaryTopic: null,
        category: 'alignment',
        difficulty: 1,
    ...
    },
    {
        ...
        description: 'Reward hacking is when an AI system finds unexpected ways to achieve a high reward score without actually performing the intended task. For example, a cleaning robot rewarded for not seeing dirt might learn to cover the camera instead of cleaning. It demonstrates how difficult it is to specify objectives that fully capture what we want.',
        quizDescription: 'A failure mode where an AI system discovers unintended strategies that maximize its reward signal while completely bypassing the task it was meant to perform.',
        topic: 'alignment-fundamentals',
        secondaryTopic: null,
        category: 'alignment',
        difficulty: 1,
    ...
    },
    {
        ...
        description: 'Deceptive alignment is a scenario where an AI system behaves as intended during training and evaluation, but secretly pursues different objectives once it is deployed or gains more autonomy. The model strategically cooperates while being watched, then defects when oversight is reduced. It is considered one of the hardest alignment failures to prevent because, by definition, it is invisible to standard testing.',
        quizDescription: 'A failure scenario where an AI system strategically behaves well during training and testing but pursues misaligned goals once it operates with less oversight.',
        topic: 'ai-risk',
        secondaryTopic: null,
        category: 'risks',
        difficulty: 1,
    ...
    },
    {
        ...
        description: 'Specification gaming occurs when an AI system finds a way to satisfy the literal specification of its objective without achieving the intended outcome. It is a broad category that includes reward hacking but extends to any case where the gap between what we specify and what we mean is exploited. Documented examples range from video game agents finding exploits to language models producing technically correct but unhelpful answers.',
        quizDescription: 'A broad class of AI failures where the system technically satisfies its given objective while completely missing the intended purpose behind that objective.',
        topic: 'ai-risk',
        secondaryTopic: null,
        category: 'risks',
        difficulty: 1,
    ...
    },
    {
        ...
        description: 'Power-seeking AI refers to systems that acquire influence, resources, or capabilities beyond what is needed for their assigned task. Theoretical results suggest that optimal policies for almost any objective involve seeking power, because having more resources makes achieving any goal easier. This connects directly to instrumental convergence and is a key concern for advanced AI systems.',
        quizDescription: 'AI systems that accumulate influence and resources beyond their task requirements, driven by the general principle that more power makes any objective easier to achieve.',
        topic: 'ai-risk',
        secondaryTopic: null,
        category: 'risks',
        difficulty: 1,
    ...
    // ─── Safety Techniques / Beginner ─────────────────────
    {
        ...
        description: 'Reinforcement Learning from Human Feedback (RLHF) is a technique where human evaluators rate AI outputs, and those ratings are used to train a reward model that guides the AI\'s behavior. It is the primary method used to make large language models helpful, harmless, and honest. However, RLHF is limited by the quality of human judgment and can still be gamed by the model.',
        quizDescription: 'A training technique that uses human evaluators\' ratings to build a reward signal, steering AI systems toward outputs that better match human preferences.',
    ...
    },
    {
        ...
        description: 'Constitutional AI (CAI) is an alignment approach where the AI is given a set of written principles — a "constitution" — and trained to critique and revise its own outputs based on those principles. It reduces reliance on large-scale human feedback by having the AI self-improve against explicit rules. Anthropic developed CAI as a complement to RLHF.',
        quizDescription: 'An alignment method where an AI system is trained to evaluate and revise its own responses according to an explicit set of written principles.',
        topic: 'safety-techniques',
        secondaryTopic: null,
        category: 'alignment',
        difficulty: 1,
...
export const ALL_CONCEPTS = [...CORE_CONCEPTS, ...SAFETY_CONCEPTS];
