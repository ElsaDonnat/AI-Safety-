...
export const ml4gCourse = {
    ...
    modules: [
        ...
        },
        {
            ...
            subtitle: 'What AI systems can do today',
            lessons: [
                {
                    id: 'ml4g-L03',
        ...
        },
        {
            ...
            subtitle: 'The paradigm powering modern AI',
            lessons: [
                {
                    id: 'ml4g-L07',
        ...
        },
        {
            ...
            subtitle: 'What it means for a machine to be generally intelligent',
            lessons: [
                {
                    id: 'ml4g-L11',
        ...
        },
        {
            ...
            subtitle: 'How compute, data, and techniques drive AI progress',
            lessons: [
                {
                    id: 'ml4g-L14',
        ...
        },
        {
            ...
            subtitle: 'Benchmarks, evaluations, and predicting AI progress',
            lessons: [
                {
                    id: 'ml4g-L18',
                    title: 'AI Benchmarks',
        ...
        },
        {
            id: 'ml4g-mod-7',
            title: 'Takeoff',
            subtitle: 'How fast AI might surpass human-level capabilities',
            lessons: [
                {
                    id: 'ml4g-L21',
